...
class Node:
	...
	UR = Up+Ui+Ud
	#UR = 32.51*error - 36.98*self.errorR_1 + 10.51*self.errorR_2 + self.UR_2
	if UR > 63:
		UR=63
	elif UR < -63:
		UR=-63
	Ui=UR-Up-Ud
	#self.errorR_2 = self.errorR_1
	self.errorR_1 = error
	#self.UR_2 = self.UR_1
	#self.UR_1 = UR
	self.UiR_1 = Ui
    ...
    def WL_Control(self):
        ...
        UL = Up+Ui+Ud
	#UL = 32.51*error - 36.98*self.errorL_1 + 10.51*self.errorL_2 + self.UL_2
        if UL > 63:
                UL=63
        elif UL < -63:
                UL=-63
        Ui=UL-Up-Ud
        #self.errorL_2 = self.errorL_1
        self.errorL_1 = error
        #self.UL_2 = self.UL_1
        #self.UL_1 = UL
	self.UiL_1 = Ui
